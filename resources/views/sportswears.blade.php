                    ...
                    @foreach($products as $product)
                        <div class="col">
                            <a href="{{route('details', $product->id)}}" class="text-decoration-none link-danger">
                                <div class="card bg-danger text-light border-danger" style="width:20rem;margin:20px 0 24px 0">
                                    <img class="img-fluid bg-secondary-subtle" src="{{asset('img/mainslidephoto2.jpg')}}" alt="image">
                                    <div class="card-body">
